        ...
        <div class="card-body">
            ...
            <form>
                <div class="mb-3">
                    ...
                    <input type="text" name="template_name" class="form-control" value="{{ $ctemplate->template_name }}"
                        id="template_name" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" onchange="uploadImage(event)" name="" class="hidden-file" id="imgUpload" hidden>
...
<script>
    ...
    async function saveTemplate(id) {
        try {
            ...
            if (!response.ok) {
                alert(data.message || 'Gagal update template');
                console.error(data);
                return;
            }

            // ✅ ALERT MUNCUL
            alert(data.message || 'Template berhasil diupdate');

            // optional (kalau mau reload)
            // location.reload();

        } catch (error) {
            console.error(error);
            alert('Terjadi kesalahan saat update template');
        }
    }
</script>